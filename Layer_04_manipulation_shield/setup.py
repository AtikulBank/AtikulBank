"""
LAYER 4: MANIPULATION SHIELD - BUILD SETUP
...
ext_modules = [
    Extension(
        name="manipulation_wrapper",
        sources=[
            "cython/manipulation_wrapper.pyx",
            "cpp/manipulation_core.cpp",
        ],
        include_dirs=[
            np.get_include(),
            "cpp/",
...
setup(
    name="manipulation_shield",
    version="1.0.0",
    description="High-performance manipulation detection with C++ backend",
